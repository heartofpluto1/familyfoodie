...
describe('RecipeWeeksPage', () => {
  ...
  describe('Successful data fetching', () => {
    ...
    it('applies correct CSS classes for layout', async () => {
      ...
      // Check stats grid
      const statsGrid = container.querySelector('.grid.grid-cols-2.md\\:grid-cols-3')
  ...
  describe('Error handling', () => {
    it('renders error state when getRecipeWeeks fails', async () => {
      ...
      expect(screen.getByTestId('header-page')).toHaveTextContent('Error fetching recipe weeks')
  ...
  describe('Empty data scenarios', () => {
    ...
    it('displays empty state when no recipes found', async () => {
      ...
      expect(screen.getByText('No recipe weeks found.')).toHaveClass('text-secondary')
    })
    ...
    it('renders empty state container with correct styling', async () => {
      ...
      const emptyStateDiv = container.querySelector('.bg-surface.border.border-custom.rounded-lg.p-8.text-center')
  ...
  describe('RecipeItem component', () => {
    ...
    it('renders last recipe item without border', async () => {
      ...
      const recipeElements = container.querySelectorAll('.font-medium.text-foreground.text-sm')
    ...
    it('renders non-last recipe items with border', async () => {
      ...
      const borderedElement = container.querySelector('.border-b.border-light.pb-3')
    ...
    it('applies correct text styling to recipe names', async () => {
      ...
      const recipeNameElement = container.querySelector('.font-medium.text-foreground.text-sm.leading-snug')
  ...
  describe('Data edge cases', () => {
    ...
    it('handles very long recipe names', async () => {
      const longNameRecipes = [
        {
          ...
          recipes: [
            { 
              id: 1, 
              recipeName: 'This is a very long recipe name that might cause display issues if not handled properly'
            }
          ]
        }
      ]
      ...
      expect(screen.getByText('This is a very long recipe name that might cause display issues if not handled properly')).toBeInTheDocument()
    })
    ...
    it('handles special characters in recipe names', async () => {
      ...
      expect(screen.getByText('Recipe with "quotes" & symbols!')).toBeInTheDocument()
  ...
  describe('Accessibility and responsive design', () => {
    ...
    it('includes responsive grid classes for stats', async () => {
      ...
      const statsGrid = container.querySelector('.grid-cols-2.md\\:grid-cols-3')
      expect(statsGrid).toBeInTheDocument()
    })
    ...
    it('includes hover effects on cards', async () => {
      ...
      const hoverCard = container.querySelector('.hover\\:shadow-md.transition-shadow')
  ...
  describe('Key attributes', () => {
    it('uses correct key attributes for mapped components', async () => {
      ...
      const recipeCards = container.querySelectorAll('.bg-surface.border.border-custom.rounded-lg.overflow-hidden')
