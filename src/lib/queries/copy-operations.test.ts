...
describe('Copy Operations Database Queries', () => {
  ...
  describe('getRecipeById', () => {
    it('should return recipe when found', async () => {
      ...
      expect(mockConnection.execute).toHaveBeenCalledWith(
        expect.stringContaining('SELECT id, name, prepTime'),
        [1]
      );
    });
  ...
  describe('getCollectionById', () => {
    it('should return collection when found', async () => {
      ...
      expect(mockConnection.execute).toHaveBeenCalledWith(
        expect.stringContaining('SELECT id, title, subtitle'),
        [1]
      );
    });
  ...
  describe('getIngredientById', () => {
    it('should return ingredient when found', async () => {
      ...
      expect(mockConnection.execute).toHaveBeenCalledWith(
        expect.stringContaining('SELECT id, name, fresh'),
        [1]
      );
    });
  ...
  describe('deleteOrphanedIngredients', () => {
    it('should find and delete orphaned ingredients', async () => {
      ...
      expect(mockConnection.execute).toHaveBeenNthCalledWith(1,
        expect.stringContaining('SELECT DISTINCT i.id'),
        [2, 2]
      );
  ...
  describe('Error Handling', () => {
    ...
    it('should handle constraint violation errors', async () => {
      ...
      await expect(copyRecipe(mockConnection, {
        id: 1,
        name: 'Test',
        prepTime: null,
        cookTime: null,
        ...
        household_id: 1,
        parent_id: null
      }, 2)).rejects.toThrow('Foreign key constraint fails');
    });
  });
