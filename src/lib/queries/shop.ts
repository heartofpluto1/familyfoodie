...
/**
 * Get shopping list for a specific household (Agent 2 implementation)
 */
export async function getShoppingListHousehold(week: string, year: string, household_id: number) {
