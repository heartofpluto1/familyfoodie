		...
		<main className="container mx-auto px-4 py-8">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				...
				<div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-sm p-6 opacity-50">
					...
					<h3 className="text-lg font-semibold mb-2 text-gray-600 dark:text-gray-400">User Management</h3>
					<p className="text-gray-500 dark:text-gray-500 text-sm">Coming soon: Manage users and permissions.</p>
				</div>
