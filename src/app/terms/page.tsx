		...
		<div className="container mx-auto px-4 py-8 max-w-4xl">
			...
			<div className="space-y-8 text-foreground">
				<div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-sm p-4 mb-8">
					<p className="text-sm">
						<strong>Beta Service Notice:</strong> Family Foodie is currently in beta. Features and functionality may change, 
						and there may be bugs or issues. We appreciate your patience and feedback as we improve the service.
					</p>
				</div>
				...
				<section>
					...
					<p className="mb-4">
						By accessing or using Family Foodie (&quot;Service&quot;), operated by Family Foodie (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), 
				...
				<section>
					...
					<p className="mb-4">
						Family Foodie is a meal planning and recipe management service that allows users to:
					</p>
				...
				<section>
					...
					<p className="mb-4">
						To use certain features of the Service, you must create an account using Google OAuth authentication. 
					...
					<p>
						...
						You may delete your account at any time by contacting us at contact@familyfoodie.co.
					</p>
				</section>
				...
				<section>
					...
					<p className="mb-4">
						You retain ownership of any recipes, meal plans, images, and other content (&quot;User Content&quot;) you create or upload to the Service. 
						By posting User Content, you grant us a worldwide, non-exclusive, royalty-free license to use, display, reproduce, and distribute 
						your User Content solely for the purpose of operating and providing the Service.
					</p>
					...
					<p className="mb-4">
						...
						non-commercial use. You understand that once a recipe is made public and copied by other users, you cannot revoke their copies even if 
						you later make your recipe private.
					</p>
				...
				<section>
					...
					<p className="mb-4">
						The Service and its original content (excluding User Content), features, and functionality are and will remain the exclusive property 
						of Family Foodie and its licensors. The Service is protected by copyright, trademark, and other laws. Our trademarks and trade dress 
				...
				<section>
					...
					<p>
						Your use of the Service is also governed by our Privacy Policy. Please review our <a href="/privacy" className="underline hover:text-foreground">Privacy Policy</a>, 
				...
				<section>
					...
					<p>
						We may perform maintenance on the Service at any time, which may result in service interruptions. We will attempt to provide notice 
						when possible, but are not obligated to do so.
					</p>
				</section>
				...
				<section>
					...
					<p className="mb-4">
						Our Service may contain links to third-party websites or services that are not owned or controlled by Family Foodie. 
						We have no control over, and assume no responsibility for, the content, privacy policies, or practices of any third-party websites or services.
					</p>
					<p>
						The Service uses third-party services including Google OAuth for authentication and Google Cloud Services for hosting. 
				...
				<section>
					...
					<p className="mb-4">
						The Service is provided on an <strong>&quot;as is&quot;</strong> and <strong>&quot;as available&quot;</strong> basis. Family Foodie expressly disclaims all warranties of any kind, 
				...
				<section>
					...
					<p className="mb-4">
						<strong>To the maximum extent permitted by law</strong>, in no event shall Family Foodie, its officers, directors, employees, or agents be liable for 
						any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, 
					...
					<p>
						<strong>In no event</strong> shall Family Foodie&apos;s total liability to you for all damages, losses, or causes of action exceed the amount you have paid 
						Family Foodie in the last six (6) months, or, if greater, one hundred dollars ($100).
					</p>
				</section>
				...
				<section>
					...
					<p>
						You agree to defend, indemnify, and hold harmless Family Foodie, its officers, directors, employees, and agents, from and against any 
						claims, liabilities, damages, judgments, awards, losses, costs, expenses, or fees (including reasonable attorneys&apos; fees) arising out 
						of or relating to your violation of these Terms or your use of the Service, including, but not limited to, your User Content, 
						any use of the Service&apos;s content, services, and products other than as expressly authorized in these Terms, or your use of any 
				...
				<section>
					...
					<p className="mb-4">
						...
						If negotiation fails, disputes shall be resolved through binding arbitration in Melbourne, Victoria, Australia, except that you may assert 
						claims in small claims court if your claims qualify.
					</p>

					<h3 className="text-xl mb-2">Class Action Waiver</h3>
					<p>
						You agree that any disputes will be resolved individually and not in a class, consolidated, or representative action. 
						You may not bring a claim as a plaintiff or a class member in a class, consolidated, or representative action.
					</p>
				</section>
				...
				<section>
					...
					<p className="mb-4">
						...
						we will provide at least 30 days notice prior to any new terms taking effect by posting the new Terms on this page and 
				...
				<section className="mt-12 p-6 bg-surface rounded-sm border border-custom">
					...
					<p>
						By using Family Foodie, you acknowledge that you have read and understood these Terms of Service and agree to be bound by them. 
