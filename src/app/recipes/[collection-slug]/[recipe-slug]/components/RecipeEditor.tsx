			...
			<div className="bg-white p-4 rounded-sm shadow space-y-4">
				...
				{editMode === 'pdf' && (
					<div className="space-y-4">
						...
						<div className="flex gap-2">
							<button onClick={() => handleCancel()} className="px-3 py-1 bg-gray-500 text-white rounded-sm hover:bg-gray-600 transition-colors text-sm">
								Cancel
							</button>
						</div>
					</div>
				...
				<button
					...
					className="w-full px-4 py-2 bg-red-600 text-white rounded-sm hover:bg-red-700 transition-colors flex items-center justify-center gap-2"
				>
