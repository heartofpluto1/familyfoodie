	...
	return (
		<div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
			...
			<div className="space-y-4">
				{/* Recipe Image Section with contextual edit button */}
					...
					{editMode === 'image' ? (
						<div className="space-y-4">
							...
							<div className="flex gap-2">
								<button onClick={() => handleCancel()} className="px-3 py-1 bg-gray-500 text-white rounded hover:bg-gray-600 transition-colors text-sm">
									Cancel
								</button>
							</div>
						</div>
						...
						<div className="relative">
							<img key={refreshKey} src={getRecipeImageUrl(recipe.filename, editMode !== 'none')} alt={recipe.name} className="w-full rounded-lg" />
							{/* Camera edit button */}
							<button
